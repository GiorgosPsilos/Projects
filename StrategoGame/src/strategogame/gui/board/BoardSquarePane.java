...
public class BoardSquarePane extends StackPane {
    ...
    public BoardSquarePane(BoardSquareType type) {
        ...
        if (type == BoardSquareType.LIGHT)
            this.setStyle("-fx-background-image: url(strategogame/media/images/board/grass1.png)");
        else if (type == BoardSquareType.DARK)
            this.setStyle("-fx-background-image: url(strategogame/media/images/board/grass2.png)");
