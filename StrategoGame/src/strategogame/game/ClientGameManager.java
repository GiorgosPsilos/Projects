...
import strategogame.gui.BoardScene;
import strategogame.gui.ClientStage;
import strategogame.gui.ConnectionScene;
import strategogame.gui.board.BoardTurnIndicator;
...
public class ClientGameManager implements Runnable {
     ...
     * 
     * @see strategogame.Game.ServerGameManager
     */
    @Override
    public void run() {
        connectToServer();
     ...
     * 
     * @see strategogame.gui.ConnectionScene.ConnectToServer
     */
