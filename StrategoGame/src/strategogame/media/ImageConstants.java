...
public class ImageConstants {
    ...
    public final static Image RED_SLAYER  = new Image(ImageConstants.class.getResource("images/pieces/red/red_spy.png").toString());
    public final static Image RED_BACK = new Image(ImageConstants.class.getResource("images/pieces/red/red_back.png").toString());
    public final static Image RED_TRAP = new Image(ImageConstants.class.getResource("images/pieces/red/red_bomb.png").toString());
    ...
    public final static Image BLUE_SLAYER  = new Image(ImageConstants.class.getResource("images/pieces/blue/blue_spy.png").toString());
    public final static Image BLUE_BACK = new Image(ImageConstants.class.getResource("images/pieces/blue/blue_back.png").toString());
    public final static Image BLUE_TRAP = new Image(ImageConstants.class.getResource("images/pieces/blue/blue_bomb.png").toString());
